        ...
        (data) => {
          ...
          const formattedPatients = Array.isArray(data)
            ? data.map((patient) => ({
                ...
                dateOfBirth: patient.personalRecords.DateOfBirth,
                city: patient.personalRecords.City,
                area: patient.personalRecords.Area,
                weight: patient.personalRecords.userWeight,
                height: patient.personalRecords.userHeight,
